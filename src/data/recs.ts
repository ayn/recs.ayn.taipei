...
export const recs: Rec[] = [
  ...
  },
  {
    ...
    area: "Zhongzheng",
    category: "food",
    note: "Old-school market stop for prepared foods, snacks, pantry things, and a very Taipei everyday-food feel. Easy to pair with CKS Memorial Hall.",
    gettingThere: { pills: [{ label: "MRT Red Line", tone: "red" }, { label: "MRT Green Line", tone: "green" }], detail: "Chiang Kai-shek Memorial Hall." },
    tags: ["market", "snacks", "easy stop"],
