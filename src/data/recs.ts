...
export const recs: Rec[] = [
  ...
  },
  {
    ...
    area: "Datong",
    category: "neighborhoods",
    note: "Old Taipei, tea, dried goods, restored buildings, small shops. Nice slower walk. If you like typography or old craft, Ri Xing Type Foundry is a worthwhile quick stop nearby.",
