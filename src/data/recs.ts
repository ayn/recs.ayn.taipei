...
export const recs: Rec[] = [
  ...
  },
  {
    ...
    area: "Songshan",
    category: "running-cycling",
    note: "Central track option for workouts near Taipei Arena. This may be the shorter warm-up track, not the full main stadium track, but it is useful if you need a measured workout spot.",
    ...
    mapQuery: "臺北田徑暖身場",
    mapUrl: "https://maps.app.goo.gl/zBhK6JbNEq5YBSk97",
  },
  {
    name: "Tianmu Sports Park and University of Taipei track / 天母運動公園",
    area: "Tianmu",
    category: "running-cycling",
