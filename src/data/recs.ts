...
export const recs: Rec[] = [
  ...
  },
  {
    ...
    gettingThere: { pills: [{ label: "MRT Red Line", tone: "red" }, { label: "MRT Green Line", tone: "green" }], detail: "Zhongshan, or Taipei Main Station by Airport MRT/TRA/HSR, then walk." },
