...
export const recs: Rec[] = [
  {
    ...
    gettingThere: { label: "Uber/taxi", tone: "car", detail: "Easiest from Taipei, especially with 2-4 people. Transit option: TRA to Ruifang, then bus or taxi up to Jiufen." },
  ...
  },
  {
    ...
    gettingThere: { label: "TRA", tone: "train", detail: "Yingge Station, then walk or take a short taxi to the old street." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red Line", tone: "red", detail: "Taipei 101 / World Trade Center. Blue Line to Taipei City Hall also works for a Xinyi walk." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red Line", tone: "red", detail: "Xiangshan, then follow signs to the trail stairs." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red/Green", tone: "mixed", detail: "Chiang Kai-shek Memorial Hall." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red/Orange", tone: "mixed", detail: "Dongmen. Start around Yongkang Street and wander from there." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red/Green", tone: "mixed", detail: "Zhongshan. Most of the good wandering is north and east of the station." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Blue/Green", tone: "mixed", detail: "Ximen." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Green/Orange", tone: "mixed", detail: "Beimen for the south end, or Daqiaotou for the north end." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red/Green", tone: "mixed", detail: "Zhongshan, or Taipei Main Station by Airport MRT/TRA/HSR, then walk." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red Line", tone: "red", detail: "Zhishan or Shipai, then bus, taxi, or Uber. From central Taipei, Uber is often simplest." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Green Line", tone: "green", detail: "Songshan. TRA to Songshan also works. The entrance is right by the temple." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red Line", tone: "red", detail: "Shuanglian, then walk west. Zhongshan also works if you are already there." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red Line", tone: "red", detail: "Jiantan, Exit 1. Do not get off at Shilin Station." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red Line", tone: "red", detail: "Taipei 101 / World Trade Center for the Taipei 101 branch." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red Line", tone: "red", detail: "Taipei 101 / World Trade Center. It is inside Taipei 101." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red/Orange", tone: "mixed", detail: "Dongmen." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Brown/Green", tone: "mixed", detail: "Nanjing Fuxing, then walk or take a short taxi depending on the exact branch." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Blue Line", tone: "blue", detail: "Shandao Temple. The entrance is upstairs in Huashan Market." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red Line", tone: "red", detail: "Shuanglian, then walk toward Ningxia Night Market." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red/Green", tone: "mixed", detail: "Zhongshan, then walk." },
  ...
  },
  {
    ...
    gettingThere: { label: "Map first", tone: "neutral", detail: "Check the current location before routing. Uber is easiest if it is not already near your day plan." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Brown Line", tone: "brown", detail: "Liuzhangli, or route through Xinyi Anhe by MRT/taxi depending on where you start." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT Red Line", tone: "red", detail: "Zhishan or Shipai, then bus, taxi, or Uber." },
  ...
  },
  {
    ...
    gettingThere: { label: "MRT/TRA", tone: "mixed", detail: "Taipei Main Station, Beimen, or Zhongshan all work. Pick whichever fits your route." },
